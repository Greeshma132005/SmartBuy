            ...
            <div className="mb-8 grid gap-4 sm:grid-cols-3">
              ...
              <Card className="border-slate-800 bg-slate-900/50">
                <CardContent className="flex items-center gap-4 p-6">
                  ...
                  <div>
                    <p className="text-sm text-slate-400">Triggered Alerts</p>
                    <p className="text-2xl font-bold text-slate-50">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                {loadingData ? (
                  ...
                  <Card className="border-dashed border-slate-700 bg-transparent">
                    <CardContent className="flex flex-col items-center py-10 text-center">
                      <BellRing className="mb-3 h-8 w-8 text-slate-600" />
                      <p className="text-sm font-medium text-slate-400">
                    ...
                    <div className="space-y-1">
                      {searchHistory.slice(0, 10).map((item, idx) => (
                        <button
                          ...
                          className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-left text-sm text-slate-300 transition-colors hover:bg-slate-800 hover:text-slate-100"
                        >
